            ...
            <div class="student-profile-head">
                @php
                    if(isset($user->images)){
                        $path=$user->images[0]->path;
                        $img=$user->images[0]->img;
                        // dd($path);
                    }else{
                        // dd('no path');
                ...
                <div class="card-body">
                  ...
                  <div class="personal-activity">
                    ...
                    <div class="views-personal">
                      <h4>{{$user->email}}</h4>
                      <h5>
                        <a href="https://preschool.dreamguystech.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="89ede8e0faf0c9eee4e8e0e5a7eae6e4">[email&#160;protected]</a>
                      </h5>
                    </div>
                  </div>
                  <div class="personal-activity">
                  ...
                  <div class="personal-activity">
                    ...
                    <div class="views-personal">
                      ...
                      <h5>
                        @php
                            $date=date('d F Y',strtotime($user->dob));
