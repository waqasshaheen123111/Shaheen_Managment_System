              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    ...
                    <input class="form-control" name="name" value="{{$user->name}}" type="text" placeholder="Enter First Name">
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                    <div class="form-group local-forms">
                ...
                {{-- <div class="col-12 col-sm-4">
                    <div class="form-group local-forms">
                      ...
                      <input class="form-control" name="password" value="{{$user->password}}" type="password" placeholder="Enter Your Password">
                    </div>
                </div> --}}
                <div class="col-12 col-sm-4">
                    <div class="form-group local-forms calendar-icon">
                    <label>Date Of Birth <span class="login-danger">*</span></label>
                    <input class="form-control datetimepicker" name="date" type="text" value="{{$user->dob}}" placeholder="{{Carbon::parse($user->dob)->format('d,F,Y')}}">
                    </div>
                </div>
                <div class="col-12 col-sm-4">
                    <div class="form-group local-forms">
                    <label>Mobile </label>
                    <input class="form-control" type="text" name="mobile" value="{{$user->mobile}}" placeholder="Enter your Mobile Number">
                    </div>
                </div>
                <div class="col-12 col-sm-4">
                    ...
                    <div class="form-group local-forms">
                        <input class="form-control" type="text" name="address" value="{{$user->adress}}" placeholder="Enter your Address" id="address-input">
                ...
                <div class="col-12 col-sm-4">
                  <div class="form-group local-forms">
                    ...
                    <select id="select_role" name="role" class="form-control select">
                      ...
                      <option value="4"{{$user->role==4 ? 'selected':''}} id="parents" >Parents</option>
                    </select>
                  </div>
                </div>
                <div class="row check_me card card-primary get_class {{ $user->role !==2 ? 'd-none': ''}}">
                        ...
                        <div class="form-group local-forms">
                          <label> Class <span class="login-danger">*</span>
                            ...
                            <select id="select_role"  class="form-control select">
                                @if ($user->student)
                                <option value="{{$user->student->classes->id}}">{{$user->student->classes->name.' ('.$user->student->classes->groups.' )'}}</option>
                                @endif
